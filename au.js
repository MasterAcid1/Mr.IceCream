...
class Client {
    ...
    loadGUI() {
        ...
        <input onchange="localStorage.setItem('botAmount', this.value);" id="BotAmount" maxlength="3" class="form-control" placeholder="Bot Amount" value="120"></input>
        ...
        `);
        if (!localStorage.getItem('botAmount')) localStorage.setItem('botAmount', 120);
    ...
    startBots(amount) {
        ...
        amount > 120 ? amount = 120 : amount = amount;
